...
class WebLMClient:
    ...
    def convert(self, url: str, return_token_count: bool = False, model_name: str = "gemini-2.0-flash") -> Dict:
        """
    ...
    def get_models(self) -> Dict[str, List[str]]:
        ...
        Returns:
            Dict: Available models by provider with the following structure:
                {
                  "google": [
...
class AsyncWebLMClient:
    ...
    async def convert(self, url: str, return_token_count: bool = False, model_name: str = "gemini-2.0-flash") -> Dict:
        """
